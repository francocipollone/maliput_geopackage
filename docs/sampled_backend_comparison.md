...
**Description:** Purpose-built HD-map format for autonomous driving (already used by maliput_osm).

**Pros:**
- Already proven through `maliput_osm`
- Rich semantic information (traffic rules, regulatory elements)
- Active community (FZI, Autoware)

**Cons:**
- Already implemented in `maliput_osm`
